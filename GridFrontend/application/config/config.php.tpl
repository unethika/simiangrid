...
|
*/
$config['grid_name'] = '@@GRID_NAME@@';
$config['grid_name_short'] = '@@GRID_NAME_SHORT@@';
...
|--------------------------------------------------------------------------
|
| List of additional avatar types that can be selected on avatar registration
|
*/
$config['extra_avatar_types'] = array();
...
|
*/
$config['sess_cookie_name']		= 'sgf_session';
$config['sess_expiration']		= 7200;
$config['sess_encrypt_cookie']	= FALSE;
$config['sess_use_database']	= TRUE;
$config['sess_table_name']		= 'sgf_sessions';
